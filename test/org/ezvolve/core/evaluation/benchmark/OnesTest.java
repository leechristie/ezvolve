...
public class OnesTest {
    ...
    public void testGetInstance() {
        FitnessFunction<BitString> instance = Ones.getInstance();
    ...
    public void testEvaluateDetailed() {
        ...
        assertEquals(Fitness.of(2), instance.evaluate(BitString.of(1, 1)));
        ...
        assertEquals(Fitness.of(1), instance.evaluate(BitString.of(0, 1, 0)));
        assertEquals(Fitness.of(2), instance.evaluate(BitString.of(0, 1, 1)));
        assertEquals(Fitness.of(1), instance.evaluate(BitString.of(1, 0, 0)));
        assertEquals(Fitness.of(2), instance.evaluate(BitString.of(1, 0, 1)));
        assertEquals(Fitness.of(2), instance.evaluate(BitString.of(1, 1, 0)));
        assertEquals(Fitness.of(3), instance.evaluate(BitString.of(1, 1, 1)));
    }
